        ...
        <div className="max-w-4xl mx-auto px-6 py-20">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-text leading-relaxed max-w-3xl mx-auto">
                    We are dedicated to helping freelancers and micro-businesses find the best tools to grow.
                    Our independent research ensures you get honest, data-driven recommendations.
                </p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 max-w-2xl mx-auto">
                <h2 className="text-2xl font-bold text-secondary mb-6 text-center">Get in Touch</h2>
